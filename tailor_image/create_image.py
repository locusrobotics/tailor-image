...
def create_bare_metal_image(image_name: str, provision_file: str, s3_bucket: str, src_dir: pathlib.Path, publish: bool):
    ...
    os.environ['DEFAULT_MANAGED_STR'] = 'This file is AUTOGENERATED, DO NOT MODIFY'
    os.environ['ANSIBLE_FORKS'] = '50'
    os.environ['HOST_KEY_CHECKING'] = 'False'
    os.environ['ANSIBLE_LIBRARY'] = find_in_path('modules', src_dir)
    ...
    os.environ['ANSIBLE_GATHER_SUBSET'] = '!all,virtual,default_ipv4,processor'
    os.environ['ANSIBLE_GATHER_TIMEOUT'] = '30'
